                  ...
                  <nav class="navbar navbar-expand-lg navbar-light bg-light">
                     ...
                     <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                           ...
                           <li class="nav-item">
                              <a class="button_set_head button_set2_head nav-link teachersheetminebutton_fixed_head"
         ...
         <div class="contact_section layout_padding margin_bottom90">
            ...
            <div class="contact_section_2 layout_padding">
               <div class="sheet_div_title">
                  <div class="teachersheetminesheet_div_title2">MY EVALUATION SHEET
                  </div>
               </div>
               <div class="button-container">
                  <router-link to="/teachersheetongoing">
                     <button class="teachersheetongoingbutton_set1 button_set1-2">Ongoing</button>
                  </router-link>

                  <a href="post.html">
                     <button class="teachersheetongoingbutton_set1 button_set1-2 teachersheetminebutton_fixed"
