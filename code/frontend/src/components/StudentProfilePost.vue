         ...
         <div class="container">
            <h1 class="contact_taital">Lawrence<!--改start-->
             <hr size="10" align="center" noshade width="50%" color="000000">
                ...
                <a href="personal.html"><button class="button_set button_set2 " >關於</button></a>
                <a href="post.html"><button class="button_set button_set2 button_fixed">貼文</button></a>
                </h1>
         </div>
              ...
              <div class="contact_section_2 layout_padding">
                  ...
                  <div class="col-md-6">
                     <div class = "personal_div">
                        <div class = "personal_div_textl">貼文</div>
