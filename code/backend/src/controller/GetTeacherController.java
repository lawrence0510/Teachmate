...
public class GetTeacherController implements HttpHandler {
    private UserService userService;
    private MySQLRepository repository;

    public GetTeacherController() {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        if (exchange.getRequestMethod().equalsIgnoreCase("OPTIONS")) {
            ...
            try {
                ...
                List<Map<String, Object>> StudentInfo = userService.getTeacherInfo(username,repository);
                if (StudentInfo != null) {
