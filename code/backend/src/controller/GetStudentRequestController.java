...
public class GetStudentRequestController implements HttpHandler {
    private UserService userService;
    private MySQLRepository repository;

    public GetStudentRequestController() {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        if (exchange.getRequestMethod().equalsIgnoreCase("OPTIONS")) {
            ...
            try {
                ...
                String studentname = jsonObject.get("props").getAsJsonObject().get("username").getAsString();

                boolean saveStudentRequestInfoSuccess = userService.saveStudentRequestInfo(teachername, studentname,repository);
                if (saveStudentRequestInfoSuccess) {
